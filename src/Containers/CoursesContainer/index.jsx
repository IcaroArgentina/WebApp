...
const CoursesPages = () => {
	...
	return (
		<>
			<Helmet>
				<title>ICARO - {`${selectedCourse?.nombre}`}</title>
				<link
					rel='canonical'
					href={`http://icaro.org.ar/cursos/${selectedCourse?.href}`}
				/>
				<meta name='description' content={`${selectedCourse?.descripcion}`} />
				<meta name='keywords' content={`${selectedCourse?.nombre}`} />
			</Helmet>
